#!/usr/bin/env python3
"""
S4_LDN Policy Sanity Tests for GC M1 NEW DATA (OOS Phase 3)
...
def main():
    print("=" * 80)
    print("S4_LDN Policy Sanity Tests for GC M1 NEW DATA (OOS Phase 3)")
    print("=" * 80)
    
    config_path = "asm_v2/configs/s4_policy_sanity_gc_m1_real_newdata_v1.json"
